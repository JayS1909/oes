...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">siyon4511@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/coffin.png" width=100 height=100 alt="PBL-A18" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		
		<h4 style="font-family:'typo' ">KETAN.B</h4>
		<h4 style="font-family:'typo' ">SE</h4>
		<h4 style="font-family:'typo' ">TCOER, Pune.</h4>
		</p>
      </div>
